...
const SignUp = (props) => {
    ...
    const signup = () => {
        if (
            ...
            return window.alert('입력되지 않은 항목이 있습니다. 다시 확인하여 주세요.')
            ...
            >
                <Grid padding="16px">
                    ...
                    <Grid padding="16px 0px 0px">
                        <Text fontSize="12px" margin="0px" color={idWarning} lineHeight="2" textIndent="15px">
                            {idConfirm}
                        </Text>
                    </Grid>
                    <Grid is_flex padding="0px 0px 27px">
                        <Input
                            placeholder="새로 생성할 ID를 입력해 주세요. (숫자나 영문 4자 이상)"
                            changeEvent={(event) => {
                    ...
                    <Grid padding="5px 0px 27px">
                        <Text fontSize="12px" margin="0px" color={pwdWarning} lineHeight="2" textIndent="15px">
                            {pwdConfirm}
                        </Text>
                        <Input
                            placeholder="패스워드를 입력해주세요. (숫자나 영문 6자 이상)"
                            type="password"
                            changeEvent={(e) => {
                    ...
                    <Grid padding="5px 0px 27px">
                        <Text fontSize="12px" margin="0px" color={pwdCheckWarning} lineHeight="2" textIndent="15px">
                            {pwdCheckConfirm}
                        </Text>
                        <Input
                    ...
                    <Grid padding="5px 0px 27px">
                        <Text fontSize="12px" margin="0px" color={nameWarning} lineHeight="2" textIndent="15px">
                            {nameConfirm}
                        </Text>
                        <Input
                    ...
                    <Grid padding="16px 0px">
                        <Button width="100%" height="auto" padding="12px 0" clickEvent={signup}>
                            회원가입 하기
                        </Button>
                    </Grid>
                    <Grid padding="5px 0px 30px">
                    <Button
                            width="100%"
                            height="auto"
                            padding="12px 0"
